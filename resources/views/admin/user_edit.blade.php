                        ...
                        <div class="w-full md:w-1/2 flex flex-col items-center ">
                            ...
                            <div class="w-3/4 mb-6 border-1 border-gray-800">
                                <input type="name" name="name" id="name" value="{{ $user->name }}"
                                    class="w-full py-4 px-8 bg-slate-200 rounded hover:ring-1 outline-blue-500">
                                @if ($errors->has('name'))
                            ...
                            <div class="w-3/4 mb-6">
                                <input type="lastname" name="lastname" id="lastname" value="{{ $user->lastname }}"
                            ...
                            <div class="w-3/4 mb-6">
                                ...
                                <br>
                                <small>Solo introducir contraseña si desea cambiarla</small>
